...
const createDatabase = async () => {
  try {
    ...
    await dbConnection.execute(`
      INSERT INTO tasks (title, project_id, estimated_hours, is_recurring, recurrence_type, recurrence_interval, created_at) VALUES
      ('Design forsiden', 1, '02:00', FALSE, NULL, 1, '2025-09-01 08:00:00'),
      ('Dagligt standup', 2, '00:30', TRUE, 'daily', 1, '2025-08-28 09:00:00'),
      ('Ugentlig rapport', 1, '01:00', TRUE, 'weekly', 1, '2025-08-26 14:00:00'),
      ('Implementer checkout', 3, '04:00', FALSE, NULL, 1, '2025-09-01 10:00:00'),
      ('Månedlig review', 2, '02:00', TRUE, 'monthly', 1, '2025-08-01 15:00:00')
    `);
